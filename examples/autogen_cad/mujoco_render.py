...
def pusher(obj_scale=None,obj_mass=None,obj_damping=None,object_pos=[0.45, -0.05, -0.275], goal_pos=[0.45, -0.05, -0.3230], distractors_pos=[], N_objects=1, mesh_file=None, distractor_mesh_files=None, friction=[.8, .1, .1]):
    ...
    asset.mesh(file=mesh_file, name="object_mesh", scale=[object_scale]*3) # figure out the proper scale
    for i in range(N_objects - 1):
